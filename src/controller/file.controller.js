...
/// determine: Controller for file upload/download
//
//
...
//--download(): receives file name as input parameter, then uses Express res.download API
//--to transfer the file at path (directory + file name) as an ‘attachment’.
